...
public interface AppStyleArbiter {
    ...
    public static final String CLASS_TOP_PANE = "top_pane";
    public static final String CLASS_CANVAS = "canvas";
    public static final String CLASS_PROPERTIES = "properties";
